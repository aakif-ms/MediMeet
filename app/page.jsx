        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold te xt-white leading-tight">Connect with doctors <br /><span className="gradient-title">anytime, anywhere</span></h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button variant="outline" asChild size="lg" className="border-emerald-700/30 hover:bg-muted/80">
                  <Link href={'/doctors'}>
                    Find Doctors
                  </Link>
                </Button>
            ...
            <div className="relative h-[400px] lg:h-[580px] rounded-xl overflow-hidden">
              <Image src="/banner2.png" alt="Doctor Consultation image" fill priority className="object-cover md:pt-14 rounded-xl" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Choose the perfect consulatation package that fits your healthcare needs
            </p>
          </div>
          <div>
            <Pricing />
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <Badge
              variant="outline"
              className="bg-emerald-900/30 border-emerald-700/30 px-4 py-1 text-emerald-400 text-sm font-medium mb-4">Success Stories</Badge>
                ...
                <Card key={index}
                  ...
                  <CardContent>
                    <div className="flex items-center mb-4">
                      ...
                      <div>
                        <h4 className="text-sm text-white">{testimonial.name}</h4>
          ...
          <Card
            ...
            <CardContent className="p-8 md:p-12 lg:p-16 relative overflow-hidden">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button size="lg" variant="outline" className="border-emerald-700/30 hover:bg-muted/80" asChild>
